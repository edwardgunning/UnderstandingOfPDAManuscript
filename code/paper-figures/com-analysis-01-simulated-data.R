...
pda_simulation_result <- readRDS(here::here("outputs", "real-data", "pda-simulation-result-01.rds"))
...
tikz(here::here("outputs", "real-data", "paper-plots", "real-vs-simulated-3d-phase-plane.tex"), 
...
dev.off()
tinytex::lualatex(
  here::here("outputs", "real-data", "paper-plots", "real-vs-simulated-3d-phase-plane.tex"))
