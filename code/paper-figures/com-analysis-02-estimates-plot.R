...
tikz(here::here("outputs", "real-data", "paper-plots", "pda-estimates-02.tex"), 
...
tinytex::lualatex(here::here("outputs", "real-data", "paper-plots", "pda-estimates-02.tex"))


# Change font to Beamer for Giles' JSM Presentation: ----------------------
options(tikzLatexPackages = c(getOption( "tikzLatexPackages"),
                              "\\renewcommand{\\familydefault}{\\sfdefault}"))
tikz(here::here("outputs", "real-data", "rough", "pda-estimates-02.tex"), 
     width = (1 * doc_width_inches),
     height = (0.4 * doc_width_inches),
     standAlone = TRUE)
p
dev.off()
tinytex::lualatex(here::here("outputs", "real-data", "rough", "pda-estimates-02.tex"))
