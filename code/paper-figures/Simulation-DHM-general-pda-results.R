...
dataset_1 <- generate_DHM_dataset_general(n = n,
...
tikz(here::here("outputs", "SHM", "paper-plots", "general-dhm-datasets.tex"),
...
tikz(here::here("outputs", "SHM", "paper-plots", "general-dhm-result.tex"),
...
tinytex::lualatex(here::here("outputs", "SHM", "paper-plots", "general-dhm-result.tex"))
